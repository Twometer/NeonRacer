...
public class GameContextFactory {
    ...
    public static GameContext createDefault() {
        ...
        return new GameContext(gameWindow, textureProvider, shaderProvider, assetProvider, gameState, physicsEngine, timer, mouseState, keyboardState, client, false);
    }
    ...
    public static GameContext createForDebug() {
        ...
        return new GameContext(gameWindow, textureProvider, shaderProvider, assetProvider, gameState, physicsEngine, timer, mouseState, keyboardState, client, true);
    }
    ...
    public static GameContext createForDesigner() {
        ...
        MouseState mouseState = new MouseState();
        KeyboardState keyboardState = new KeyboardState();
        return new GameContext(gameWindow, textureProvider, shaderProvider, assetProvider, gameState, physicsEngine, null, mouseState, keyboardState, null, false);
    }
